...
# Gradient-level drift probe for the FedSD theorem check.
...
# Disable if needed:
#   USE_WANDB=0 ./run_fedsd_gradient_probe_sweep.sh
...
run_job() {
    ...
    local method_name="fedsd_alpha${alpha_tag}_gprobe"
...
echo "========== FedSD Gradient Probe Sweep =========="
echo "LOG_ROOT=${LOG_ROOT}, ROUNDS=${ROUNDS}, SEED=${SEED}, PROBE_INTERVAL=${PROBE_INTERVAL}, PROBE_BATCHES=${PROBE_BATCHES}"
...
wait
echo "✅ FedSD gradient probe sweep 완료"
