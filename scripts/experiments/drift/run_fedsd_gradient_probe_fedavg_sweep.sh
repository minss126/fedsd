...
# Disable if needed:
#   USE_WANDB=0 ./scripts/experiments/drift/run_fedsd_gradient_probe_fedavg_sweep.sh
...
echo "========== FedSD Gradient Probe Sweep: FedAvg =========="
...
wait
echo "✅ FedAvg gradient probe sweep 완료"
